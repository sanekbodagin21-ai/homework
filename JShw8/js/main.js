...
const createTodoElement = (text, year) => {
    const list = document.createElement("li");
    list.classList.add("todo");
    list.innerHTML = `
    <div class="todos-text">${text}</div>
    <p class="todos-year">${year}</p>
    ...
    const handleCreateTodo = (todos, text) => {
        ...
        const todoElement = createTodoElement(newTodo[todoKeys.text], newTodo[todoKeys.year]);
